...
exports.getAudioPeaks = void 0;
const fs_1 = require("fs");
const rxjs_1 = require("rxjs");
const buffer_1 = require("buffer");
const decode = require('audio-decode');
const getAudioPeaks = (audio, samples) => {
...
function audioPeaksFromFile(audiofile, samples) {
    return (0, rxjs_1.of)(audiofile).pipe((0, rxjs_1.switchMap)((filepath) => {
        return (0, rxjs_1.from)(fs_1.promises.readFile(filepath));
    }), (0, rxjs_1.map)((filedata) => {
        let filedatabuffer = filedata.buffer;
        let thisblob = new buffer_1.Blob([filedatabuffer]);
        return thisblob;
    }), (0, rxjs_1.switchMap)((blob) => (0, rxjs_1.from)(blob.arrayBuffer())), (0, rxjs_1.switchMap)((arrayBuffer) => (0, rxjs_1.from)(decode(arrayBuffer))), (0, rxjs_1.map)((audioBuffer) => filterData(audioBuffer, samples ? samples : 70, false)), (0, rxjs_1.map)((filteredData) => normalizeData(filteredData)), (0, rxjs_1.map)((normalizedData) => normalizedData[0]));
}
